FUNCTION CALL_JACOSPAR_LIMB_shoheidatabase_LMmethod_20240220_limbCase1, orbit, $
  alt_range, $
...
;  Radiusm(0,*,0) = interpol(Radius_ap(1,*), Radius_ap(0,*), z(0,*));;;;;;;2022/1/1 kogure risei 線形に粒径が減少するプロファイル
  ...
  ztpn_ini = GETZTPN_LimbTest_new_20240220(MEAN(geometry(4, *)), MEAN(geometry(5, *)), MEAN(geometry(6, *)), MEAN(geometry(7, *)), z, cov, StartRadius, appriori_files);T[K],P[pa],CO2ndens,,
...
;    Radiuss(0, *, 0) = resultsprefit(*, 1)
  ...
  ; -----------------------
  radtemp = CREATE_SYNTHETIC_SPECTRA_Limb_shoheiDatabase_limbCase1(orbit, alt_range, wn_apriori, z, ztpn(*, *, 0), Ht, geometry, dwn, FOV, Radiusm(*, *, 0), $
