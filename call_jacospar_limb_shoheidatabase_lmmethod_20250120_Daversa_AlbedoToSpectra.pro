FUNCTION CALL_JACOSPAR_LIMB_shoheidatabase_LMmethod_20250120_Daversa_AlbedoToSpectra, orbit, $
  alt_range, $
...
;    Radiuss(0, *, 0) = resultsprefit(*, 1)
  ...
  ;;;;;;;;;;;;;;;;;;;; Radius from Daversa
  Radiusm(0, 0, 0) = 2e-4
  Radiusm(0, 1, 0) = 1.7e-4
  Radiusm(0, 2, 0) = 1.45e-4
  Radiusm(0, 3, 0) = 0.9e-4
  Radiusm(0, 4, 0) = 0.95e-4
  Radiusm(0, 5, 0) = 0.8e-4
  Radiusm(0, 6, 0) = 0.75e-4
  Radiusm(0, 7, 0) = 0.7e-4
  Radiusm(0, 8, 0) = 0.65e-4
  Radiusm(0, 9, 0) = 0.6e-4
