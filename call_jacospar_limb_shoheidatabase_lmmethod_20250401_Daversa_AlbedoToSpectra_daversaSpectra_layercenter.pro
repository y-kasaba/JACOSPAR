FUNCTION call_jacospar_limb_shoheidatabase_lmmethod_20250401_Daversa_AlbedoToSpectra_daversaSpectra_layercenter, orbit, $
  alt_range, $
...
;    Radiuss(0, *, 0) = resultsprefit(*, 1)
  ...
  ; -----------------------
  radtemp = CREATE_SYNTHETIC_SPECTRA_Limb_shoheiDatabase_onlydust_layercenter(orbit, alt_range, wn_apriori, z, ztpn(*, *, 0), Ht, geometry, dwn, FOV, Radiusm(*, *, 0), $
...
FREE_LUN, lun_output
  ...
  WHILE (iter LT itermax) AND (convX(iter - 1) GE epsilonX) AND ~nofit OR (Ratio lt 0) DO BEGIN;;;;20211109 KogureRisei.for L-M method.
    ...
    radtemp = CREATE_SYNTHETIC_SPECTRA_Limb_shoheiDatabase_onlydust_layercenter(orbit, alt_range, wn_apriori, z, ztpn(*, *, iter), Ht, geometry, dwn, FOV, Radiusm(*, *, iter), Radiuss(*, *, iter), wn_albedo, S_albedo(*, iter), jactemp, $
