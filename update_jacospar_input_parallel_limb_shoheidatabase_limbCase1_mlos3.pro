FUNCTION UPDATE_JACOSPAR_INPUT_PARALLEL_Limb_ShoheiDatabase_limbCase1_mlos3, seq, $
  outputfile, $
  fov, $
  npf, $
  nang, $
...
;  thesol = geom(3, *) 
  ...
  FOR i = 0, nspectra - 1 DO BEGIN
    ...
    IF ~onlynames THEN BEGIN
      ...
      PRINTF, lun, "  mlos = 3         ! method for defining plos (0:theV, 1:theP, 2:angPOV, 3:hgtH)";PRINTF, lun, "  mlos = 2         ! method for defining plos (0:theV, 1:theP, 2:angPOV, 3:hgtH)";;2021/4/19
      PRINTF, lun, "  plos = " + STRING(plos(i)) + " ! theP"
