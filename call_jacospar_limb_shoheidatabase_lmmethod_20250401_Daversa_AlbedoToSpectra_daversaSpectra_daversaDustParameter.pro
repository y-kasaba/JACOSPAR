FUNCTION call_jacospar_limb_shoheidatabase_lmmethod_20250401_Daversa_AlbedoToSpectra_daversaSpectra_daversaDustParameter, orbit, $
  alt_range, $
...
;    Radiuss(0, *, 0) = resultsprefit(*, 1)
  ...
  FOR i = 0, nlayer - 1 DO BEGIN
    CASE i OF
      ...
      8: BEGIN
         ...
         END
      9: BEGIN
           Radiusm[0, i, 0] = 0.6e-4
         END
      ELSE: BEGIN
               Radiusm[0, i, 0] = 0.5e-4  ; デフォルト値
            END
    ENDCASE
  ENDFOR
  ...
  ; -----------------------
  radtemp = CREATE_SYNTHETIC_SPECTRA_Limb_Emiliano(orbit, alt_range, wn_apriori, z, ztpn(*, *, 0), Ht, geometry, dwn, FOV, Radiusm(*, *, 0), $
