FUNCTION CREATE_SYNTHETIC_SPECTRA_Limb_Emiliano, orbit, $
  alt_range, $
  wn, $
  z, $
  ztpn, $
  ...
  FOR i = 0, nwindows - 1L DO BEGIN
    ...
    ENDIF ELSE BEGIN
      temp = CREATE_JACOSPAR_INPUT_FILES_Limb_Emiliano(orbit, wnrange(*, i) + [-FBord, FBord], gas_species, aerosols_species, alt_range, dwn, FOV, z, ztpn, Ht, geometry, Radiusm, Radiuss, wn_albedo, S_albedo, $
