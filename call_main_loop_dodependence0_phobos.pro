...
PRO call_main_loop_dodependence0_phobos
...
ls = 0
 ...
 ;アプリオリファイルの定義 
  ...
  ;--------------------- ここまでは共通 --------------------------;
     ...
     ;----------------------- 感度実験5 ---------------------------;
     ;保存ディレクトリ名
     NAMEPLUSDIR = '20240406_nadirtest_ice2times_LMinitial=1d1_limit1d10_radius2d-4';NAMEPLUSDIR = '20240225_convergetest_1_LimbTestDust_1d-6_NadirTestH2Oice_1d-6'
     ...
     LM_update_rate = 2d;vの更新係数 　解から遠かった場合：v/2、 解に近付いた場合：v*2
     ...
     ;関数の呼び出し
     c = call_jacospar_limb_shoheidatabase_lmmethod_20240220(orbit, altitude, NAMEPLUSDIR = NAMEPLUSDIR,$
     ...
     ;----------------------- 感度実験6 ---------------------------;
     ;保存ディレクトリ名
     NAMEPLUSDIR = '20240406_nadirtest_ice2times_LMinitial=1d3_limit1d10_radius2d-4';NAMEPLUSDIR = '20240225_convergetest_2_LimbTestDust_1d-4_NadirTestH2Oice_1d-4'
