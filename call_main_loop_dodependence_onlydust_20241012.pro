...
PRO call_main_loop_dodependence_onlydust_20241012
  ...
  ;===============
    ;共通引数の設定
    WNRANGE = [4000D,10600D];[2660D, 10600D]
    DWN = 10D
    ONLYFITSPECIES = [3L]
    ...
    ;保存ディレクトリ名
    NAMEPLUSDIR = '20250311_invsa_20_20_10_10_v=1d1_daversa_0-45km_albedo40_noice_dodepend_4000-10600_AlbedoToSpectra';NAMEPLUSDIR = '20240225_convergetest_1_LimbTestDust_1d-6_NadirTestH2Oice_1d-6'
    ...
    filenameice = 'H2O_ice_zero.dat';'NadirTest_H2O_ice.dat';;;;;phobos版のJACOSPAR同様、初めのリトリーバル感度をダストと同じにするために、ダストと同じアプリオリプロファイルを用いる。
    ...
    ;関数の呼び出し
    c = call_jacospar_limb_shoheidatabase_lmmethod_20250120_Daversa_AlbedoToSpectra(orbit, altitude, NAMEPLUSDIR = NAMEPLUSDIR, cov_parameters = cov_parameters,$
    ...
    ;----------------------- 感度実験2   doradiusprefit ---------------------------;
    ;保存ディレクトリ名
    NAMEPLUSDIR = '20250311_invsa_10_10_10_10_v=1d1_daversa_0-45km_albedo40_noice_dodepend_4000-10600_AlbedoToSpectra';NAMEPLUSDIR = '20240225_convergetest_1_LimbTestDust_1d-6_NadirTestH2Oice_1d-6'
    ...
    c = call_jacospar_limb_shoheidatabase_lmmethod_20250120_Daversa_AlbedoToSpectra(orbit, altitude, NAMEPLUSDIR = NAMEPLUSDIR, cov_parameters = cov_parameters,$
      ...
      StartRadius = StartRadius, appriori_files = appriori_files, LM_initial_v = LM_initial_v,LM_update_rate = LM_update_rate, $
      /plottotalopticaldepth, /nofov, /makeplot ,/MAKEPRINT,/fitradius,/dodependence)
    ;----------------------- 感度実験3   doradiusprefit ---------------------------;
    ;保存ディレクトリ名
    NAMEPLUSDIR = '20250311_invsa_1_1_1_1_v=1d1_daversa_0-45km_albedo40_noice_dodepend_4000-10600_AlbedoToSpectra';NAMEPLUSDIR = '20240225_convergetest_1_LimbTestDust_1d-6_NadirTestH2Oice_1d-6'
    ...
    c = call_jacospar_limb_shoheidatabase_lmmethod_20250120_Daversa_AlbedoToSpectra(orbit, altitude, NAMEPLUSDIR = NAMEPLUSDIR, cov_parameters = cov_parameters,$
      ...
      ;----------------------- 感度実験2 ---------------------------;
      ;保存ディレクトリ名
      NAMEPLUSDIR = '20250311_invsa_10_10_10_10_r1d-4_0-60km_threshold1d-3';NAMEPLUSDIR = '20240225_convergetest_1_LimbTestDust_1d-6_NadirTestH2Oice_1d-6'
      ...
      LM_update_rate = 10d;vの更新係数 　解から遠かった場合：v/2、 解に近付いた場合：v*2
      ;LM_v_limit = 1d10;vの最大側のlimitの値。この値よりもvが大きくならないようにする。
      THRESHOLD = 1d-3;;;;;収束の条件を規定するεに使用する値。小さいほど収束条件が厳しくなる。これまでのデフォルトは1d-4(phobos上のプログラムでは1d-3だったが、充足度合いから判断して1d-4の方が適切)
